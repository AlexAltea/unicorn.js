...
function demoInit() {
    e = new uc.Unicorn(uc.ARCH_ARM64, uc.MODE_ARM);
    a = new ks.Keystone(ks.ARCH_ARM64, ks.MODE_LITTLE_ENDIAN);
    d = new cs.Capstone(cs.ARCH_ARM64, cs.MODE_ARM);
    ...
    paneRegisters.add(new Register('FP',  'i64', uc.ARM64_REG_FP));
