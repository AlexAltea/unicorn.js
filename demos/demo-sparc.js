...
function demoInit() {
    e = new uc.Unicorn(uc.ARCH_SPARC, uc.MODE_SPARC32 | uc.MODE_BIG_ENDIAN);
    a = new ks.Keystone(ks.ARCH_SPARC, ks.MODE_SPARC32 | uc.MODE_BIG_ENDIAN); // TODO
    d = new cs.Capstone(cs.ARCH_SPARC, cs.MODE_SPARC32 | cs.MODE_BIG_ENDIAN);
